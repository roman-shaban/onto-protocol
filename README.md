...
* **Incident:** Any deviation from policy or system failure (as analyzed in our [Systemic Risk Analysis](https://zenodo.org/records/19707375)).

## 🎓 Citation
If you use this protocol or refer to its concepts, please cite it as:
> Shaban, R. (2026). Onto Protocol: A Semantic Standard for Autonomous AI Agents. Zenodo. [https://zenodo.org/records/19707375](https://zenodo.org/records/19707375)
...
---
*Part of the [Catalyst OS](https://github.com/roman-shaban/catalyst-os) Ecosystem.*
